    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/quizzes/create') }}" class="btn btn-success btn-sm" title="Add New Quizzes">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <a href="{{ url('/quizzes/' . $item->id) }}" title="View Quizzes"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                        <a href="{{ url('/quizzes/' . $item->id . '/edit') }}" title="Edit Quizzes"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
